...
def get_santa_fe_data():
    time_series_raw = np.load("./data/sk_Santa_Fe_2000.npy")
...
if __name__ == '__main__':
    exp_name = "QLSTM_SantaFe"
    data,_,_=get_santa_fe_data()
    x,y=prepare_time_series_data(data,seq_length)
    main(exp_name,x,y)
